...
<style>
    ...
    /* Mobile responsive layout for phone viewports (360px - 430px) */
    @media (max-width: 600px) {
        ...
        /* Ensure period selector buttons fit cleanly on small screens */
...
def render_nt_history_chart(metrics):
    ...
    # Compact period selector using radio buttons styled horizontally (3M default)
    period = st.radio(
        "Time Period",
        ["1M", "3M", "6M", "1Y", "All"],
        index=1,
...
def main():
    ...
    st.caption(
        ...
        "It is not affiliated with or endorsed by AEMO, any gas producer, or any government agency. "
